...
func Run(files []string, stdin string) (string, string, error, string) {
	...
	jarFileIncludes := ".:/usr/local/bin/JUNIT/junit-4.13.2.jar:/usr/local/bin/JUNIT/hamcrest-core-1.3.jar:/usr/local/bin/JUNIT/gson-2.10.1.jar:/usr/local/bin/JUNIT/okhttp-3.9.1.jar:/usr/local/bin/JUNIT/okio-1.9.0.jar:/usr/local/bin/JUNIT/approvaltests-4.1.jar"
